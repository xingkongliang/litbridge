...
A practical tool. A focused prototype. A solution that helps with one real student problem.
...
This subtheme focuses on students who are blocked because university systems are difficult to understand. The problem may involve course selection, degree progression, administrative forms, extension processes, special consideration, enrolment rules, prerequisite requirements, graduation checks, or university policies. A strong project should help students interpret a confusing process and produce a clear next-step plan.
